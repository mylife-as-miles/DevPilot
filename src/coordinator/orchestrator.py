...
Instead of creating a fresh Agent per devpilot cycle, runs one continuous
...
class CoordinatorOrchestrator:
    """Orchestrates devpilot-guided research via a single persistent Agent.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        parts.append(
            f"## Guidelines\n\n"
            f"- Hard cap: {self.config.max_cycles} devpilot cycles{depth_note} "
