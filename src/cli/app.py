"""Top-level Typer app for the devpilot CLI."""
...
# handling for `devpilot --help`. Instead, we detect the no-subcommand case
...
def main() -> None:
    ...
    If invoked with no subcommand (e.g. `devpilot` or `devpilot --cwd .`),
