...
- DevPilot-CLI unit and integration suite after the ACP adapter changes
...
- native searchable Memory, Skills, and Audits navigation backed by DevPilot-CLI APIs
